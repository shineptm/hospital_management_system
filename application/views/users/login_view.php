    ...
    <section id="wrapper">
        <div class="login-box login-sidebar">
            <div class="white-box">
				...
				action="<?php echo site_url(); ?>/users/login/login_process">
                    ...
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Don't have an account? <a href="<?php echo site_url(); ?>/users/user/register" class="text-primary m-l-5"><b>Sign Up</b></a></p><!-- echo base_url(); $this->config->item('site_url').  -->
                        </div>
                    </div>
                </form>
                <!--
